...
public class StringNotes
{
    public static void main( String[] args )
    {
         ...
         *      concatenates the second string operand to the end of the
         ...
         */
        name = "Harry";
        char c = name.charAt( 0 );                  // returns 'H'
        c = name.charAt( 4 );                       // returns 'y'
        c = name.charAt( name.length() - 1 );       // returns 'y'
        //c = name.charAt( name.length());          // returns StringIndexOfOfBoundsException
        ...
        //sub = greeting.substring( 7, 14 );                // generates StringIndexOfOfBoundsException
