...
public class CarTest
{
    ...
    public void testGetGasInTank()
    {
         ...
         *  Specify teh expected value first and the returned value second.
         *  For double (only), specify a third value which is the epsilon (i.e.,
         *      how close is close enough to be equal).
         */
